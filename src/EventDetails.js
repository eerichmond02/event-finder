  ...
  render() {
    ...
    return (
      <div className='card'>
        {this.state.event ?
          <div>
            <p className='back'><a onClick={() => this.props.history.goBack()}>Go back</a></p>
            <div className='large-8 columns'>
              ...
              <p><a href={this.state.event.url} target='_blank' rel='noopener noreferrer'>More Info & Get Tickets</a></p>
            </div>
          </div>
        : <p>Loading...</p>
      }
